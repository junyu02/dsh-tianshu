...
const TEMP_MD = '~/AppData\\Local\\Temp\\wt-edit-test.md';
...
const proc = spawn('C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe', [
  ...
  '--user-data-dir=~/AppData\\Local\\Temp\\wt-chrome-func3',
  'about:blank',
], { stdio: 'ignore' });
...
(async () => {
  ...
  const step15 = await evaluate(`(async function(){
    ...
    try{
      ...
      await new Promise(function(r){setTimeout(r,400)});
      st.openTab('main',0,{kind:'file',path:'~/Projects\\\\dsh-tianshu\\\\01_content\\\\src\\\\client\\\\index.tsx'});
      ...
      st.openTab('main',0,{kind:'file',path:'~/Projects\\\\dsh-tianshu\\\\01_content\\\\src\\\\client\\\\styles.ts'});
  ...
  const step11 = await evaluate(`(async function(){
    ...
    await new Promise(function(r){setTimeout(r,400)});
    st.openTab('main',0,{kind:'file',path:'~/Projects\\\\dsh-tianshu\\\\02_process\\\\PRD.md'});
    await new Promise(function(r){setTimeout(r,1200)});
    ...
    st.openTab('main',0,{kind:'file',path:'~/Projects\\\\dsh-tianshu\\\\01_content\\\\package.json'});
    await new Promise(function(r){setTimeout(r,900)});
  ...
  const step12 = await evaluate(`(async function(){
    ...
    try{
      ...
      await new Promise(function(r){setTimeout(r,400)});
      var rootToken=encodeURIComponent('~/Projects\\\\dsh-tianshu\\\\04_test\\\\fixture-site');
  ...
  const step16 = await evaluate(`(async function(){
    ...
    try{
      var st=window.__dshWorktable.splitStore;
      var probe=await fetch('/api/worktable/write',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({path:'~/AppData/Local/Temp/wt-edit-test.md',content:'# ORIG'})}).catch(function(){return null;});
      ...
      if(out.writeRouteReady){
        ...
        await new Promise(function(r){setTimeout(r,400)});
        st.openTab('main',0,{kind:'file',path:'~/AppData\\\\Local\\\\Temp\\\\wt-edit-test.md'});
        await new Promise(function(r){setTimeout(r,1200)});
        ...
        var chk=await fetch('/api/worktable/file?path='+encodeURIComponent('~/AppData\\\\Local\\\\Temp\\\\wt-edit-test.md')).then(function(r){return r.text()}).catch(function(){return null});
  ...
  const step19 = await evaluate(`(async function(){
    ...
    try{
      ...
      st.open(spec);
      await new Promise(function(r){setTimeout(r,400)});
      var rt=encodeURIComponent('~/Projects\\\\dsh-tianshu\\\\04_test\\\\fixture-site');
