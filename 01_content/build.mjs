...
if (pluginManifest.version !== pkg.version) {
  throw new Error('dsh-tianshu build: package.json version (' + pkg.version + ') != dsh.plugin.json version (' + pluginManifest.version + ') — 发版前先统一两处版本号')
}

const clientBanner = {
  js: "window.__ModuleLoader__.load({ id: 'dsh-tianshu', factory: (require) => { var module = { exports: {} }; var exports = module.exports;",
}
...
console.log('[dsh-tianshu build] done: lib/index.js, lib/client.js')
